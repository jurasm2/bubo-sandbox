...
//    private $descendantParams = NULL;
    ...
    public function hideRootElement() {
        $this->includeRootElement = FALSE;
    }

    public function setTopLevelPage($topLevelPage) {
        $this->topLevelPage = $topLevelPage;
        return $this;
    }
    ...
    public function traverse() {
        ...
        $openedLevels = array();
        $topLevelPage = $this->topLevelPage ?: $this->presenter['pages'];
